...
//private:
	...
	bool MakeData(const FieldInfo& fieldInfo, const std::string& str, const std::string& opType, Data& data, ConDP& condi);
	...
	std::string TransferCharacter(const std::string& str);
